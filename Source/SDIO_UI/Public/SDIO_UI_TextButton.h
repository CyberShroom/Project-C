...
UCLASS(meta = (ShortToolTip = "A button that changes the text color when hovered. Makes it look like the text is the button."))
class SDIO_UI_API USDIO_UI_TextButton : public UUserWidget
{
	GENERATED_BODY()
